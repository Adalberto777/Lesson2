...
Console.WriteLine($"сумма всех положительных элементов массива: {GetpositiveSum(array)}");

Console.WriteLine($"cумма всех отрицательных элементов массива: {GetnegativeSumn(array)}");